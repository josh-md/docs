...
<AccordionGroup>
  ...
  <Accordion title="Failed" description=" Message was sent but did not get delivered" icon="exclamation" iconType="regular">
    ...
    **If step 1 or 2 fail to deliver, **take a screenshot of both messages & conversations and**email them to ** [**support@messagedesk.com**](mailto:support@messagedesk.com)** **for further assistance
...
- **Be registered:** Ensure A2P 10DLC or Toll‑Free verification is complete and matches your use case.
...
## Ongoing prevention (lightweight routine)

- **Weekly:** Send a test to each major carrier.
- **Monthly:** Review delivery rates and failed message reasons in MessageDesk.
- **Quarterly:** Audit templates for compliance and clarity.
...
- **Customer opted out?** They must reply to receive texts again.
- **Urgent and SMS failing?** Call or email first, then fix and retry SMS.
- **Can I text short codes?** Many short codes won’t work with virtual numbers; ask for a standard 10‑digit alternative.