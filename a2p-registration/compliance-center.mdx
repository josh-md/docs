...
Set how your inbox handles SMS oopt‑outs, signatures, and STOP keywords. Clear, simple, carrier‑friendly.
...
<Steps>
  ...
  <Step title="Click Compliance Center">
    ...
    **_note:_ **If you're not the account administrator, you may not have access to certain workspace settings.
  </Step>
</Steps>
